    ...
    <PublicLayout>
      ...
      <section className="flex flex-col items-center justify-center text-center py-24 px-6 bg-primary-100">
        ...
        <p className="max-w-2xl text-xl mb-8 text-primary-900">
          At WeWake, we blend astrology, rituals, and spiritual teachings to guide you toward clarity, peace, and
          purpose. Join thousands on a transformative journey grounded in Sanatana Dharma.
        </p>
        ...
        <div className="grid gap-12 md:grid-cols-3 max-w-7xl mx-auto">
          <div className="p-8 bg-white shadow-lg rounded-2xl hover:shadow-xl transition">
            ...
            <p className="text-lg mb-4">
              Receive personalized Vedic astrology readings that offer deep insights into your life path, relationships,
              career, and spiritual well-being.
            </p>
          ...
          <div className="p-8 bg-white shadow-lg rounded-2xl hover:shadow-xl transition">
            ...
            <p className="text-lg mb-4">
              Participate in powerful poojas performed by learned priests to bring peace, abundance, and spiritual
          ...
          <div className="p-8 bg-white shadow-lg rounded-2xl hover:shadow-xl transition">
            ...
            <p className="text-lg mb-4">
              Enroll in expert-led sessions on Sanatana Dharma, yoga, meditation, and ancient scriptures to deepen your
              spiritual knowledge.
            </p>
      ...
      <section id="about" className="py-20 px-6 bg-primary-100 text-primary-900">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl mb-6">
            WeWake is more than a service its a movement. Rooted in the timeless teachings of Sanatana Dharma, we
            provide spiritual tools and guidance to help individuals live with intention and truth.
          </p>
          <p className="text-lg">
            Through our team of seasoned astrologers, spiritual mentors, and Vedic scholars, we offer resources to
            elevate your consciousness and reconnect with your highest self. Our platform is designed to be a sanctuary
            for seekers from all walks of life.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div className="p-6 bg-accent-white border border-primary-100 rounded-xl shadow-md">
              <p className="text-lg italic">
                “My astrology reading was incredibly accurate and enlightening. I feel more confident in my path
                forward.”
              </p>
            ...
            <div className="p-6 bg-accent-white border border-primary-100 rounded-xl shadow-md">
              <p className="text-lg italic">
                “The pooja ceremony brought a sense of peace to my home that I hadnt felt in years. Highly recommend!”
              </p>
              <p className="mt-4 font-semibold">— Ramesh I.</p>
            </div>
            <div className="p-6 bg-accent-white border border-primary-100 rounded-xl shadow-md">
              <p className="text-lg italic">
                “Their webinars helped me finally understand the deeper meaning behind the Bhagavad Gita.
                Life-changing.”
              </p>
            ...
            <div className="p-6 bg-accent-white border border-primary-100 rounded-xl shadow-md">
              <p className="text-lg italic">
                “I’ve gained clarity and spiritual strength through WeWake’s guidance. It’s been a blessing.”
              </p>
      ...
      <section id="contact" className="py-20 px-6 bg-primary-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-6">
            Have questions, ideas, or ready to begin your spiritual journey? Our team is here to guide you. Reach out
            anytime.
          </p>

  ...
  return (
    <section className="small-section text-center !pb-0">
      <div className="container">
        <div className="flex items-center relative rounded-xl md:rounded-2xl lg:rounded-3xl min-h-80 lg:min-h-96 xl:min-h-128 2xl:min-h-144 3xl:min-h-[626px] overflow-hidden text-accent-white">
          <Image src={banner} alt="home-banner" className="absolute size-full inset-0 object-cover" />
          <Grid className="justify-center w-full">

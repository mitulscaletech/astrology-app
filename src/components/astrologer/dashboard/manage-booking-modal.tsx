...
import RescheduleAppointment from "./reschedule-appointment-modal";
    ...
    <>
      <Modal open={isOpen} onOpenChange={onClose}>
        <ModalContent size="xl">
          <ModalTitle>Manage Booking</ModalTitle>
          <ModalDescription>
            <>
              ...
              <div>
                ...
                <Grid className="mb-4 lg:mb-5 3xl:mb-6">
                  ...
                  <Grid.Col>
                    <label className="mb-1 inline-flex text-secondary/70 text-xs font-medium">
      ...
      <RescheduleAppointment isOpen={isRescheduleOpen} onClose={() => setIsRescheduleOpen(false)} />
    </>
  );
};

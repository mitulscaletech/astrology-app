  ...
  return (
    <div className="relative">
      <button
        ...
        className="block hover:text-secondary w-5 h-5 text-primary relative"
      >
        <IconNotification />
        <span className="absolute px-1 translate-x-1/2 -translate-y-1/2 min-w-4 h-4 leading-3.5 bg-primary text-accent-white text-xs border border-primary-100 rounded-full top-0 end-0">
          4
        </span>
      </button>

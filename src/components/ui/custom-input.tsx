      ...
      <>
        <div className="relative w-full">
          <input
            ...
            id={id}
            className={cn(
              "peer h-13 md:h-15 w-full font-medium rounded-md border-2 px-3 pt-6 pb-2 text-base lg:text-lg text-secondary placeholder-transparent transition-all outline-none",
